...
public class Settings implements PersistentStateComponent<Settings> {
    ...
    public void initDefault() {
        ...
        this.templateGroupMap.put("MybatisPlus", loadTemplateGroup("MybatisPlus", "entity", "mapper", "service", "serviceImpl", "controller"));
        this.templateGroupMap.put("MybatisPlus-Mixed", loadTemplateGroup("MybatisPlus-Mixed", "entity", "mapper", "service", "serviceImpl", "controller"));
